...
M906 X1000 Y1000 Z1000 E940 I50                     ; Set motor currents (mA) and motor idle factor in per cent
M92 X200.0 Y200.0 Z1600.0 E836.0                    ; Set steps per mm (25 June 2019)
M566 X600 Y600 Z80 E3600             			    ; Set maximum instantaneous (jerk) speed changes (mm/min)
M201 X1750 Y1750 Z20 E1500                          ; Set accelerations (mm/s^2)
...
G31 X2 Y42 Z1.92 H5 P25 							; Customize your offsets appropriately. (Nozzle X)
