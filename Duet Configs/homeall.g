...
G1 S1 X-320 Y-320 F4000 ; move quickly to X or Y endstop and stop there (first pass)
G1 S1 X-320             ; home X axis
G1 S1 Y-320             ; home Y axis
G1 X5 Y5 F2000          ; go back a few mm
G1 S1 X-320 F360        ; move slowly to X axis endstop once more (second pass)
G1 S1 Y-320 F360        ; then move slowly to Y axis endstop
G90                     ; absolute positioning


G91						; relative positioning
G1 Z5 F200 S2			; lift Z relative to current position
G90                     ; absolute positioning
G1 X142 Y142 F4000		; Move to (near) center of bed
G30						; Probe the bed
