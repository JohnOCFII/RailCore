...
echo "DEBUG: First Lift Z in deployprobe.g" 
G1 H2 Z15 F4000        ; move Z 15 for clearance above dock.
...
G90                           ; absolute positioning
G1 H2 Z10 F3000               ; move bed to clear probe from build surface 
