...
G31 X-4 Y36 Z1.75 H5 P25 							; Customize your offsets. (Nozzle X) Subtle Design Sheet: August 31 2020
...
M591 D0 P7 C"connlcd.encb" S0 E50 L1.2 R50:150 A1 	; Pulse-type filament monitor
;                                                   ; sensitivity 1.20mm/pulse, allowed movement 50% to 150%, check every 50.0mm
;                                                   ; S1 is enabled, S0 is disabled
...
; M557 X41:281 Y41:299 P2:2                         ; Set Default Mesh - NOTE: take probe offset into account - corners only (magnets avoided)
